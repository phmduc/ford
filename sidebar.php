		...
		<div class="accordion" id="accordionExample">
			...
			<div class="card">
				<div class="card-header" id="headingTwo">
					<button class="btn-block text-left" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
						<div class="box-2-header">
							Hổ trợ trực tuyến
						</div>
						<div class="view">
			...
			<div class="card">
				<div class="card-header" id="headingThree">
					<button class="btn-block text-left" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
						<div class="box-3-header">
							tin tức
						</div>
						<div class="view">
			...
			<div class="card">
				<div class="card-header" id="headingFour">
					<button class="btn-block text-left" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
						<div class="box-4-header">
							Dòng xe bán chạy
						</div>
						<div class="view">
			...
			<div class="card">
				<div class="card-header" id="headingFive">
					<button class="btn-block text-left" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="true" aria-controls="collapseFive">
						<div class="box-5-header">
							Fanpage Facebook
						</div>
						<div class="view">
			...
			<div class="card">
				<div class="card-header" id="headingSix">
					<button class="btn-block text-left" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix">
						<div class="box-6-header">
							Liên kết website
						</div>
						<div class="view">
			...
			<div class="card">
				<div class="card-header" id="headingSeven">
					<button class="btn-block text-left" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="true" aria-controls="collapseSeven">
						<div class="box-7-header">
							thống kê
						</div>
						<div class="view">
